...
(function(){
    ...
    (function() {
    var p = "3271003", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3271003||'',
    guid:window.ftGUID_3271003||'',
    confID:window.ftConfID_3271003||'0',
    ftReturn: window.ftReturn_3271003||'',
    keyword:window.ftKeyword_3271003||'',
    ftId:window.ftId_3271003||'',
    ftImpId:window.ftImp3271003 && window.ftImp3271003.impID || '',
    campaignID: '95834',
    cID:'92688',
    pID:'3271003',
    creativeID:'2301039',
    exttrack:[],
    extscript:[""],
    clickTags: ['http://servedby.flashtalking.com/click/8/95834;3271003;2301039;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://aichallenge.intel.com/space?utm_source=StackOverflow&utm_medium=banner&utm_content=Data_Scientists&utm_campaign=DRD_17_134'],
    statBaseURL: 'http://stat8.flashtalking.com/reportV3/ft.stat?114498977-3271003;2301039;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/327/3271003/2301039/image/2301039.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/95834;3271003;202;pixel;StackOverflowUS;TopLeaderAITags/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/95834;3271003;2301039;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://aichallenge.intel.com/space?utm_source=StackOverflow&utm_medium=banner&utm_content=Data_Scientists&utm_campaign=DRD_17_134',
    divID:'ftdiv3271003',
    altimgID:'ftalt3271003',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3271003 && parseInt(window.ftImp3271003.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3271003') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3271003'),
    pageVisible: 'maybe',
