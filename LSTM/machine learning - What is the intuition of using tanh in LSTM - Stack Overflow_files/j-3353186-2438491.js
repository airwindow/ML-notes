...
(function(){
    ...
    (function() {
    var p = "3353186", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3353186||'',
    guid:window.ftGUID_3353186||'',
    confID:window.ftConfID_3353186||'0',
    ftReturn: window.ftReturn_3353186||'',
    keyword:window.ftKeyword_3353186||'',
    ftId:window.ftId_3353186||'',
    ftImpId:window.ftImp3353186 && window.ftImp3353186.impID || '',
    campaignID: '97673',
    cID:'94390',
    pID:'3353186',
    creativeID:'2438491',
    exttrack:[],
    extscript:[""],
    clickTags: ['http://servedby.flashtalking.com/click/8/97673;3353186;2438491;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ai.intel.com/ziva-dynamics/?utm_campaign=2018-Q4-Global-AIPG_18_09_T1&utm_source=StackOverflow&utm_medium=banner&utm_content=IntelAI-Meg_300x250_Static_CAF_CSTM&utm_keyword=Learn_More&cid=2018-Q4-Global-AIPG_18_09_T1'],
    statBaseURL: 'http://stat8.flashtalking.com/reportV3/ft.stat?123642753-3353186;2438491;',
    centreAd: true,
    width:300,
    height:250,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/335/3353186/2438491/image/2438491.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/97673;3353186;202;pixel;StackOverflowUS;SidebarAITags/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/97673;3353186;2438491;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://ai.intel.com/ziva-dynamics/?utm_campaign=2018-Q4-Global-AIPG_18_09_T1&utm_source=StackOverflow&utm_medium=banner&utm_content=IntelAI-Meg_300x250_Static_CAF_CSTM&utm_keyword=Learn_More&cid=2018-Q4-Global-AIPG_18_09_T1',
    divID:'ftdiv3353186',
    altimgID:'ftalt3353186',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3353186 && parseInt(window.ftImp3353186.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3353186') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3353186'),
    pageVisible: 'maybe',
